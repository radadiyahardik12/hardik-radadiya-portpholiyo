  ...
  return (
    <div className='px-4 h-fit pb-9 '>
      <div className='mx-auto max-w-screen-xl'>
        <section id="home" className="w-full pt-10 flex gap-10 xl:gap-0 flex-col md:flex-row items-center font-titleFont border-b-gray-700">
          ...
          <div className="w-full lgl:w-1/2 flex justify-center items-center relative">
            <img src={photo1} alt="Johan Buttecga" className="w-[270px] h-[400px] lgl:w-[450px] lgl:h-[680px] z-10" />
